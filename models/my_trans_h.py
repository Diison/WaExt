...
from pykeen.regularizers import Regularizer, TransHRegularizer
...
class MyTransH(EntityRelationEmbeddingModel):
    r"""An implementation of MyTransH [wang2014]_.
    ...
    In MyTransH, each relation is represented by a hyperplane, or more specifically a normal vector of this hyperplane
    ...
    .. seealso::
       ...
       - OpenKE `implementation of MyTransH <https://github.com/thunlp/OpenKE/blob/master/models/MyTransH.py>`_
    ---
    citation:
        author: Wang
        year: 2014
    ...
    #: The custom regularizer used by [wang2014]_ for MyTransH
    regularizer_default: ClassVar[Type[Regularizer]] = TransHRegularizer
    #: The settings used by [wang2014]_ for MyTransH
    ...
    def regularize_if_necessary(self, *tensors: torch.FloatTensor) -> None:
        ...
        if tensors:
            raise ValueError("no tensors should be passed to MyTransH.regularize_if_necessary")
