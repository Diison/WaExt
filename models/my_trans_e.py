...
class MyTransE(EntityRelationEmbeddingModel):
    r"""An implementation of MyTransE [bordes2013]_.

    MyTransE models relations as a translation from head to tail entities in :math:`\textbf{e}`:

    .. math::

        \textbf{e}_h + \textbf{e}_r \approx \textbf{e}_t

    This equation is rearranged and the :math:`l_p` norm is applied to create the MyTransE interaction function.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        .. seealso::
           ...
           - OpenKE `implementation of MyTransE <https://github.com/thunlp/OpenKE/blob/OpenKE-PyTorch/models/MyTransE.py>`_
        """
        super().__init__(
