...
"""Implementation of the WComplEx model."""
...
class WComplEx(ERModel):
    r"""An implementation of WComplEx [trouillon2016]_.

    WComplEx is an extension of :class:`pykeen.models.DistMult` that uses complex valued representations for the
    ...
    $\textbf{x}$. Because the Hadamard product is not commutative in the complex space, WComplEx can model
    ...
    #: The LP settings used by [trouillon2016]_ for WComplEx.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param regularizer_kwargs:
            additional keyword arguments passed to the regularizer. Defaults to `WComplEx.regularizer_default_kwargs`.
        :param kwargs:
            Remaining keyword arguments to forward to :class:`pykeen.models.EntityRelationEmbeddingModel`
        """
        regularizer_kwargs = regularizer_kwargs or WComplEx.regularizer_default_kwargs
        super().__init__(
